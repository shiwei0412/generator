...
public class XingtianCommentGenerator implements CommentGenerator {
    ...
    public XingtianCommentGenerator() {
        super();
...
//        topLevelClass.addJavaDocLine(" */"); //$NON-NLS-1$
        ...
        topLevelClass.addAnnotation("@QueryModel(queryModelName=\"" + introspectedTable.getFullyQualifiedTable().getIntrospectedTableName()+"\")");
    }
...
//        field.addJavaDocLine(" */"); //$NON-NLS-1$
        ...
        if(introspectedColumn.isDim() == true) {
        	field.addAnnotation("@QueryDim(fieldNames=\"" + introspectedColumn.getActualColumnName()+"\")");
        }else {
        	field.addAnnotation("@QueryIndex(fields=\"" + introspectedColumn.getActualColumnName()+"\")");
        }
    }
